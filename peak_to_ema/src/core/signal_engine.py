...
def evaluate_symbol(
    ...
    *,
    ...
    has_trade_levels = m15.entry_trigger > 0 and m15.stop > 0
    mandatory_ok = h1.rejection_candle and m15.ready and has_trade_levels
    ...
    elif not has_trade_levels:
        reason_code = "m15_invalid_trade_levels"
    elif score < 75:
