...
class DeleteIdParseTests(unittest.TestCase):
    ...
    def test_written_russian_date_is_not_a_document_id(self) -> None:
        self.assertEqual(parse_document_ids_for_delete_command("удали документы 1 мая"), [])
        self.assertEqual(parse_document_ids_for_delete_command("удали файл 12 мая 2026"), [])
        self.assertEqual(parse_document_ids_for_delete_command("удали все документы 1 мая"), [])
        self.assertEqual(parse_document_ids_for_delete_command("убери файл 3 мая"), [])
        self.assertEqual(parse_document_ids_for_delete_command("удали документы 1-го июня 2025"), [])

    def test_year_phrase_is_not_a_document_id(self) -> None:
        self.assertEqual(parse_document_ids_for_delete_command("удали файлы 2026 года"), [])
        self.assertEqual(parse_document_ids_for_delete_command("удали документы 2025 год"), [])
        self.assertEqual(parse_document_ids_for_delete_command("удали документ 2026"), [2026])
    ...
    def test_id_plus_date_keeps_only_the_id(self) -> None:
        ...
        self.assertEqual(
            parse_document_ids_for_delete_command("удали документ 254 от 12 мая 2026"),
            [254],
        )
...
class MoveIdParseTests(unittest.TestCase):
    ...
    def test_date_is_not_a_move_id(self) -> None:
        ...
        self.assertEqual(
            parse_document_ids_for_move_command("перенеси документ 12 мая 2026 в дело Банкротство"),
            [],
        )
